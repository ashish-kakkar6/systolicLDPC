...
| `rtl/systolic_gauss_jordan/input.sv` | [Minimal input pipeline](systolic-gauss-jordan-files/input.md) | Collapsed reference feeder from A/B RAMs to the staggered mesh ingress |
| `rtl/systolic_gauss_jordan/controller.sv` | [Bottom-trace top](systolic-gauss-jordan-files/controller.md) | Minimal reference top that exposes only the bottom architectural trace |
...
The matching cocotb suite is documented in
