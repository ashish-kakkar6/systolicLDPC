...
from common import minsum_reference, quantize_llr
...
posterior_sw, hard_sw = minsum_reference(H, syndrome, prior_q, max_iter)
software_reference_error = np.asarray(hard_sw, dtype=np.uint8)
